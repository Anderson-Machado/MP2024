...
namespace MP.Core.Entities
{
    public class LogAcesso: Entity
    {
        ...
        /// DS_EQUIPAMENTO
        /// </summary>
        public string DsEquipamento { get; set; } = "LEITORES HONEYWELL";
        /// <summary>
        /// DS_AREA_ORIGEM
        /// </summary>
        ...
        /// DS_GRUPO
        /// </summary>
        public string DsGrupo { get; set; } = "LEITORES HONEYWELL";
        /// <summary>
        /// NM_PESSOA
        /// </summary>
        public string Nome { get; set; }

        public void DefinirAreasComBaseNoSentidoConsulta()
        {
            if (SendidoConsulta == 2)
            {
                DsAreaOrigem = "INTERNA";
                DsAreaDestino = "EXTERNA";
            }
            else
            {
                DsAreaOrigem = "EXTERNA";
                DsAreaDestino = "INTERNA";
            }
        }
    }
}
