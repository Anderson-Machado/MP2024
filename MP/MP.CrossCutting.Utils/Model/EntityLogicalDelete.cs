...
{
    public abstract class EntityLogicalDelete : Notifiable<Notification>, IAuditableLogicalDeletion, IIdentifiable
    {
        ...
        protected EntityLogicalDelete(Guid id)
        {
            SetId(id);
            SetCreatedAt();
        }

        protected EntityLogicalDelete()
            : this(Guid.NewGuid())
        {
        }
        ...
        /// <summary>
        /// Set DeletedAt is current DateTimeOffset
        /// </summary>
        protected void SetDeletedDate() => DeletedAt = DateTimeOffset.Now;
        ...
        /// <summary>
        /// Verify DeletedAt has value
        /// </summary>
        /// <returns></returns>
        public virtual bool IsDeleting() => DeletedAt is not null;
