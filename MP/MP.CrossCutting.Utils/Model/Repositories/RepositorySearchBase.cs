...
{
    public abstract class RepositorySearchBase<TEntity> : IRepositorySearch<TEntity> where TEntity : class, IIdentifiable
    {
        protected readonly DbContext _dbContext;

        protected RepositorySearchBase(DbContext dbContext)
        {
